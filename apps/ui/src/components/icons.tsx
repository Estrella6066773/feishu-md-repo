...
export function IconFeishu({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      <rect x="2" y="2" width="20" height="20" rx="5" fill="url(#feishu-gradient)" />
      <path
        d="M8 16l2.5-7 2 5.5L14.5 9 17 16"
        stroke="white"
        strokeWidth="1.6"
        strokeLinecap="round"
      ...
      />
      <defs>
        <linearGradient id="feishu-gradient" x1="2" y1="2" x2="22" y2="22">
          <stop stopColor="#3370ff" />
          <stop offset="1" stopColor="#245bdb" />
        </linearGradient>
      </defs>
    </svg>
  );
...
export function IconToolbox({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
